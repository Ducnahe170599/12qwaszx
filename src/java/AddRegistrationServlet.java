...
// */
//
//import com.example.dao.RegistrationsDBContext;
...
////
////        response.sendRedirect("Addregistrations.jsp"); // Redirect to the registrations page
//            int userID = Integer.parseInt(request.getParameter("userID"));
//        int subjectID = Integer.parseInt(request.getParameter("subjectID"));
//        int packageID = Integer.parseInt(request.getParameter("packageID"));
//        double totalCost = Double.parseDouble(request.getParameter("totalCost"));
...
//        String createdAt = request.getParameter("createdAt");
//        
//        RegistrationsDBContext.addRegistration(userID, subjectID, packageID, totalCost, status, validFrom, validTo, createdAt);
//        
